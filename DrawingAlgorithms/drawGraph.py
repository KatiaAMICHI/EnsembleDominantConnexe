...
def mis_i():
    ...
    plt.savefig("../pngRapport/mis5.png")
...
def A_i():
    ...
    for node in G:
        ...
        if node in [2, 3]:
            color_map.append('grey')
        elif node in [10, 12, 4]:
            color_map.append('blue')
        elif node in [6, 7, 8, 14, 15]:
            color_map.append('grey')
        elif node in [5, 9, 13, 16]:
            color_map.append('black')
        elif node in [11, 1]:
    ...
    nx.draw_networkx_edges(G, pos,
                           edgelist=[(5, 10), (10, 13), (10, 11), (11, 12), (12, 16), (12, 9), (9, 4), (4, 1)],
...
def MCDS():
    ...
    plt.savefig("../pngRapport/MCDS.png")
